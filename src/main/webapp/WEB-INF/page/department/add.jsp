	...
	<script type="text/javascript">
		$.validator.setDefaults({
			submitHandler: function() {
				...
				$.post("<%=request.getContextPath()%>/department/",
						$("#fm").serialize(),
						function(data){
							if(data.code != 200){
			...
			$("#fm").validate({
				rules : {
					name : {
						required:true,
						remote: {
							url: "<%=request.getContextPath() %>/department/findDepartmentByName",     //后台处理程序
							type: "post",               //数据发送方式
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="main_locbg font2"><img src="${pagePath}/res/images/pointer.gif">&nbsp;当前位置：部门管理&nbsp;&gt;&nbsp;添加部门</td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		<tr>
			<td class="font3 fftd">
				<table>
					<tr>
						<td class="font3 fftd">部门名：<input name="name" id="name"  size="20" /></td>
					</tr>
					<tr>
