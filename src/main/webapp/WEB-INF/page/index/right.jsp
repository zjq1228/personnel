...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<link rel="stylesheet" href="<%=request.getContextPath()%>\res\css\about.css">

	<style>

		.page { width:100%;background:#F0F0F0 url('<%=request.getContextPath()%>\res\img\dian2.png') repeat-x; }
...
<div class="box">
	...
	<ul class="event_year">
		...
		<li class="current"><label for="2013">2020</label></li>

		<li><label for="2012">2019</label></li>

		<li><label for="2011">2018</label></li>

		<li><label for="2010">2017</label></li>

		<li><label for="2009">2016</label></li>

		<li><label for="2008">2015</label></li>

		<li><label for="2007">2014</label></li>

		<li><label for="2006">2013</label></li>

		<li><label for="2005">2012</label></li>

		<li><label for="2004">2011</label></li>

		<li><label for="2003">2010</label></li>

		<li><label for="2002">2009</label></li>
	...
	<ul class="event_list">
		...
		<div>
			...
			<li><span>3月13日</span><p><span>完成5333单任务</span></p></li>

			<li><span>3月26日</span><p><span>完成522单任务</span></p></li>

			<li><span>4月-11月</span><p><span>完成5444单任务</span></p></li>

			<li><span>6月11日</span><p><span>完成5222单任务</span></p></li>

			<li><span>9月10日</span><p><span>完成5444单任务</span></p></li>
...
<script src="<%=request.getContextPath()%>\res\js\jquery.min_v1.0.js" type="text/javascript"></script>
