...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function add() {
                location.href = "<%=request.getContextPath()%>/user/toInsert"
            }
            //删除
            function del() {
                selectedValue();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${pagePath}/res/images/pointer.gif">&nbsp;当前位置：用户管理&nbsp;&gt;&nbsp;用户查询</td>
    ...
    <tr valign="top">
        <td height="30">
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tr>
                    <td class="fftd">
                        <form name="empform" method="post" id="empform" action="${pagePath}/user/show">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">用户名：<input type="text" name="userName"> 用户状态：<select name="status" style="width: 173px;">
                                    ...
                                    </select> <input type="button" value="查询" onclick="selectBy()"/>  <input type="reset" value="清空"/>  <input onclick="del()" type="button" value="删除" />
                                    </td>
                                </tr>
                            </table>
                        </form>
